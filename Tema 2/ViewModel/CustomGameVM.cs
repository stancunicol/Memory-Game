...
{
    public class CustomGameVM : INotifyPropertyChanged
    {
        ...
        public CustomGameVM(int rows, int columns, TimeVM timeVM)
        {
            this.timeVM = timeVM;
        ...
        public CustomGameVM(GameState state)
        {
